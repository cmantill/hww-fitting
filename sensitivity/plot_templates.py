...
class postfit:
    def __init__(self, args):
        ...
        self.colors = {'signal':r.TColor.GetColor("#163d4e"),
                       ...
                       'zjets':r.TColor.GetColor("#cf9ddb"),
                       'ttbar':r.kCyan,
                       'other':r.TColor.GetColor("#cf9ddb")
        }

        outdir = './plots/'+self.tag+self.year+'/'
        ...
        self.sig = 'signal'
        self.data = 'data_obs'
        self.procs = [self.data, self.sig, 'zjets', 'ttbar', 'wjets', 'QCD']
    ...
    def plot_settings(self, histname, plots):
        ...
        stack.GetXaxis().SetTitle(self.var)
        ...
        raterr.GetXaxis().SetTitle(self.var)
...
if __name__=="__main__":
    ...
    parser.add_argument("-f", "--fitfile", dest="fitfile", required=True)
